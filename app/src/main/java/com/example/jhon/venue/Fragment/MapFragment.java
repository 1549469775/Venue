...
import com.example.jhon.venue.Adapter.MapRVAdapter;
...
//        toolbar.setTitle("Home");
    ...
    private void initDate() {
        ...
        rvMap.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false));
        adapter = new MapRVAdapter(getContext(), stories);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public boolean onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                //页面跳转，详情页
                EventBus.getDefault().postSticky(stories.get(position));
...
//
    ...
    @OnClick(R.id.fab_hide)
    public void onViewClicked() {
        if (rvMap.getVisibility()==View.GONE && !stories.isEmpty()){
            rvMap.setVisibility(View.VISIBLE);
        }else if (rvMap.getVisibility()==View.VISIBLE){
